...
const TRANSITION_CONFIG: Transition = { ease: "easeInOut", duration: 0.5 }
...
const heroVariants = cva(
  "relative min-h-svh w-full overflow-hidden",
  {
    variants: {
      layout: {
        default:
          "flex flex-col items-start text-start justify-start text-start place-content-start",
        colLeft: "flex flex-col justify-start items-start",
      },
    },
    defaultVariants: {
      layout: "default",
