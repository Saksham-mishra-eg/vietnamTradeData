...
export default function RadialOrbitalTimeline({
  ...
  const getStatusStyles = (status: TimelineItem["status"]): string => {
    switch (status) {
      ...
      case "pending":
        return "text-white bg-gray-400 border-gray-400";
      default:
        return "text-white bg-gray-400 border-gray-400";
    }
  };
      ...
      <div className="relative w-full max-w-4xl h-full flex items-center justify-center">
        ...
        >
          <div className="absolute w-16 h-16 rounded-full bg-gradient-to-br from-purple-500 via-blue-500 to-teal-500 animate-pulse flex items-center justify-center z-10">
            <div className="absolute w-20 h-20 rounded-full border border-blue-500/30 animate-ping opacity-70"></div>
            <div
          ...
          {timelineData.map((item, index) => {
            ...
            return (
              ...
              >
                ...
                {isExpanded && (
                  <Card className="absolute top-20 left-1/2 -translate-x-1/2 w-64 bg-white backdrop-blur-lg border-gray-200 shadow-xl shadow-gray-900/10 overflow-visible">
                    ...
                    <CardContent className="text-xs text-gray-700">
                      ...
                      <div className="mt-4 pt-3 border-t border-gray-200">
                        <div className="flex justify-between items-center text-xs mb-1">
                          ...
                          <span className="font-mono text-gray-900">{item.energy}%</span>
                        </div>
