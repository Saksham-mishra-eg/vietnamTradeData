  ...
  return (
    <div className="px-4 py-8 sm:py-16 bg-gradient-to-b from-gray-50 to-white dark:from-gray-900 dark:to-gray-800 overflow-hidden">
      <div className="max-w-6xl mx-auto">
        ...
        >
          <span className="inline-block py-1 px-3 rounded-full bg-blue-600/20 dark:bg-blue-400/20 text-blue-700 dark:text-blue-300 font-medium text-xs sm:text-sm uppercase tracking-wider">
            {title}
          </span>
          <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mt-3 sm:mt-4 px-4">
            {subtitle}
          </h3>
          <div className="w-16 sm:w-24 h-1 bg-gradient-to-r from-blue-600 to-blue-400 dark:from-blue-400 dark:to-blue-300 mx-auto mt-4 sm:mt-6"></div>
        </motion.div>
          ...
          <div className="flex justify-center mt-6 sm:mt-8">
            {Array.from({ length: testimonials.length - visibleCount + 1 }, (_: unknown, index: number) => (
              ...
              >
                ...
                {index === currentIndex && (
                  <motion.div
                    className="absolute inset-0 rounded-full bg-white/40 dark:bg-white/40"
                    animate={{ 
                      scale: [1, 1.8],
                      opacity: [1, 0] 
                    }}
