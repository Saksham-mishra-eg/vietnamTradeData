                        ...
                        <input
                          ...
                          placeholder={
                            searchType === 'hscode' 
                              ...
                              : 'Enter Product Name (e.g., electronics, textiles)'
                          }
        ...
        >
          <div className="mt-12 grid grid-cols-2 md:grid-cols-4 gap-6 max-w-5xl mx-auto">
            {[
              ...
              >
                <div className="backdrop-blur-sm rounded-2xl p-6 border border-gray-200 hover:border-transparent hover:shadow-xl transition-all duration-300 text-center">
